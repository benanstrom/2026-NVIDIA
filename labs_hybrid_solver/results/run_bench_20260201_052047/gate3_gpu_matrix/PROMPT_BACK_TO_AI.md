...
- dcqo: best_final_energy=26.0, best_seed_energy=66, t_mts_total_s=3.000
- dcqo_plus: best_final_energy=26.0, best_seed_energy=66, t_mts_total_s=3.000
- pce: best_final_energy=26.0, best_seed_energy=34, t_mts_total_s=3.000
- qaoa: best_final_energy=26.0, best_seed_energy=62, t_mts_total_s=3.001
- random: best_final_energy=26.0, best_seed_energy=58, t_mts_total_s=3.001
...
```json
{
  ...
  "run_tag": "bench",
  "skipped_oom": [
    "Skipped: qaoa N=40 needs ~16384.0 GB state vector (\u00d72.5 safety = 40960.0 GB), but only 70.6 GB free",
    "Skipped: dcqo N=40 needs ~16384.0 GB state vector (\u00d72.5 safety = 40960.0 GB), but only 70.6 GB free",
    "Skipped: dcqo_plus N=40 needs ~16384.0 GB state vector (\u00d72.5 safety = 40960.0 GB), but only 70.6 GB free"
  ]
}
```
