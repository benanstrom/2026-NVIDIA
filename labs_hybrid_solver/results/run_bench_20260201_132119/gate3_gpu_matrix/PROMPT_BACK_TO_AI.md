...
- dcqo: best_final_energy=67.0, best_seed_energy=187, t_mts_total_s=3.001
- dcqo_plus: best_final_energy=67.0, best_seed_energy=187, t_mts_total_s=3.001
- pce: best_final_energy=67.0, best_seed_energy=91, t_mts_total_s=3.000
- qaoa: best_final_energy=67.0, best_seed_energy=127, t_mts_total_s=3.001
- random: best_final_energy=67.0, best_seed_energy=219, t_mts_total_s=3.001
...
```json
{
  ...
  "run_tag": "bench",
  "skipped_oom": [
    "  [OOM safety-net] qaoa N=35 failed: requested size is too big",
    "  [OOM safety-net] dcqo N=35 failed: requested size is too big",
    "  [OOM safety-net] dcqo_plus N=35 failed: requested size is too big"
  ]
}
```
